...
export default function Page() {
  return (
    <div className="fade-in" style={{ display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',minHeight:'65vh',textAlign:'center',padding:24,fontFamily:'Inter,sans-serif',color:'#e2e8f0' }}>
      <div style={{ width:80,height:80,borderRadius:20,background:'rgba(99,102,241,0.12)',border:'1px solid rgba(99,102,241,0.2)',display:'flex',alignItems:'center',justifyContent:'center',fontSize:36,marginBottom:24 }}>📋</div>
      ...
      <h1 style={{ fontFamily:'Space Grotesk,sans-serif',fontSize:34,fontWeight:800,marginBottom:12 }}>Copy Trading</h1>
      <p style={{ color:'#64748b',fontSize:15,maxWidth:420,lineHeight:1.65,marginBottom:32 }}>Follow and auto-copy the best traders in real time. Set your risk limits, choose your traders, and let profits follow.</p>
