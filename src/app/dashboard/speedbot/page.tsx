...
export default function Page() {
  return (
    <div className="fade-in" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '60vh', textAlign: 'center', padding: 24 }}>
      ...
      <h1 className="font-display" style={{ fontSize: 36, fontWeight: 800, marginBottom: 14 }}>Speedbot</h1>
      <p style={{ color: 'hsl(215 20% 55%)', fontSize: 16, maxWidth: 420, lineHeight: 1.65, marginBottom: 32 }}>Ultra-fast execution engine for high-frequency synthetic index trading with sub-second response times.</p>
