...
export default function Page() {
  return (
    <div className="fade-in" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '60vh', textAlign: 'center', padding: 24 }}>
      ...
      <h1 className="font-display" style={{ fontSize: 36, fontWeight: 800, marginBottom: 14 }}>Reports</h1>
      <p style={{ color: 'hsl(215 20% 55%)', fontSize: 16, maxWidth: 420, lineHeight: 1.65, marginBottom: 32 }}>Detailed analytics on your trading performance — win rates, P&L history, bot stats, and profit charts over time.</p>
